        ...
        if tag_name in _DECOMPOSE_TAGS:
            ...
            for attr in ("href", "src", "data", "poster"):
                ...
                if val and isinstance(val, str):
                    ...
                    # we can bypass the expensive sanitization calls for the majority of safe strings.
